...
public class GuiInputParser extends Parser {
	...
	public static final int
		T__1=1, T__0=2, Whitespace=3, DialogId=4, GroupId=5, TabId=6, CompId=7, 
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'{'", "'}'", "Whitespace", "DialogId", "'Group'", "'Tab'", 
		"CompId", "Styles", "MinCon", "MaxCon", "RegexCon", "RequiredCon", "HolderCon", 
	...
	public static class CompConContext extends ParserRuleContext {
		...
		public List<TerminalNode> RequiredCon() { return getTokens(GuiInputParser.RequiredCon); }
		...
		public TerminalNode RequiredCon(int i) {
			return getToken(GuiInputParser.RequiredCon, i);
		}
	...
	public final ComponentContext component() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(25); match(NameWord);
			setState(26); match(QuotedCharText);
			setState(27); match(CompId);
			setState(29);
			_la = _input.LA(1);
			if (_la==DefaultValue) {
				{
				setState(28); match(DefaultValue);
				}
			}
	...
	public final GroupContext group() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(34); match(QuotedCharText);
			setState(35); match(GroupId);
	...
	public final TabContext tab() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(48); match(QuotedCharText);
			setState(49); match(TabId);
	...
	public final DialogContext dialog() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(67); match(QuotedCharText);
			setState(68); match(DialogId);
			setState(69); match(DefaultValue);
			setState(71);
			_la = _input.LA(1);
			if (_la==T__1) {
				{
				setState(70); dialogCon();
				}
			}
	...
	public static final String _serializedATN =
		...
		"\6\tV\n\t\r\t\16\tW\3\t\3\t\5\t\\\n\t\3\t\2\2\n\2\4\6\b\n\f\16\20\2\4"+
		"\3\2\13\23\3\2\13\f`\2\22\3\2\2\2\4\33\3\2\2\2\6$\3\2\2\2\b\60\3\2\2\2"+
		...
		"\2\2\2\30\26\3\2\2\2\31\32\7\4\2\2\32\3\3\2\2\2\33\34\7\24\2\2\34\35\7"+
		"\26\2\2\35\37\7\t\2\2\36 \7\25\2\2\37\36\3\2\2\2\37 \3\2\2\2 \"\3\2\2"+
		"\2!#\5\2\2\2\"!\3\2\2\2\"#\3\2\2\2#\5\3\2\2\2$%\7\26\2\2%&\7\7\2\2&(\7"+
		"\3\2\2\')\5\4\3\2(\'\3\2\2\2)*\3\2\2\2*(\3\2\2\2*+\3\2\2\2+,\3\2\2\2,"+
		"-\7\4\2\2-\7\3\2\2\2.\61\5\6\4\2/\61\5\4\3\2\60.\3\2\2\2\60/\3\2\2\2\61"+
		"\t\3\2\2\2\62\63\7\26\2\2\63\64\7\b\2\2\64\66\7\3\2\2\65\67\5\b\5\2\66"+
		...
		"C\3\2\2\2B@\3\2\2\2CD\7\4\2\2D\r\3\2\2\2EF\7\26\2\2FG\7\6\2\2GI\7\25\2"+
